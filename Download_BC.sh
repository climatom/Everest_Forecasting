...
## Begin interpolation to BCC (27.8456 86.7489)
...
cdo -s -O remapbil,lon=86.9250_lat=28.003 ${outdir}GFS_surface_merged.nc ${outdir}GFS_surface_int.nc 
cdo -s -O remapbil,lon=86.9250_lat=28.003 ${outdir}GFS_press_merged.nc ${outdir}GFS_press_int.nc 

# Interpolate height here - using  
/home/lunet/gytm3/anaconda2/bin/python ${outdir}Process_BC.py 5298 ${outdir}
